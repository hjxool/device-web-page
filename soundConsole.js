...
Vue.component('single-channel', {
    ...
    // watch: {
    //     channelNum: function (newValue, oldValue) {
    //         this.newValue = newValue;
    //         let reg = /^(\-)?\d+(\.\d{1})?$/
    //         if (Number(newValue) != Number(oldValue) && reg.test(Number(newValue)) && newValue.length > 0) {
    //             if (Number(newValue) < -56) {
    //                 this.channelNum = -56;
    //             } else if (Number(newValue) > 12) {
    //                 this.channelNum = 12;
    //             } else {
    //                 this.channelNum = Math.floor(Number(newValue) * 10 + 0.5) / 10;
    //             }
    ...
    template: `
        <div class="singleChannel">
            ...
            <slider-bar @channel-num="channelNum=$event" :channelNum="channelNum_temp"></slider-bar>
...
Vue.component('single-channel-right', {
    ...
    template: `
        <div class="singleChannel">
            ...
            <slider-bar-right @channel-num="channelNum=$event" :channelNum="channelNum_temp"></slider-bar-right>
            <div style="height: 10.02%;width: 100%;"></div>
        </div>
    `
});
...
let sound = new Vue({
    ...
    created: function () {
        ...
        this.deviceId = '20211201_094654_8578554042075301';
